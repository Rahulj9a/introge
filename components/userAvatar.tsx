...
const UserAvatar: React.FC<UserAvatarProps> = ({ className, userPic, username, name }) => {
    return (
        <div className={cn("flex rounded-full border-[1px] border-gray-500 hover:border-white gap-4 justify-center items-center space-x-2 p-1 cursor-pointer", className)}>
            <div className="w-8 h-8 rounded-full flex items-center justify-center bg-white text-black font-bold">
