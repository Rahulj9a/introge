...
const BlogTemplate: React.FC<BlogTemplateProps> = ({
    ...
    return (
        <Link href={data.url as string} target="_blank" className="w-[300px] h-[380px] rounded-md sh relative shadow-[rgba(17,_17,_26,_0.1)_0px_0px_30px] shadow-black" >
            {onDelete ? (
                <div className="rounded-md absolute -top-2 -right-2">
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger>
